...
class SBW(nn.Module):
    def __init__(self):
        ...
        config_path = model_dir / "speechtokenizer/pretrained_model/speechtokenizer_hubert_avg_config.json"
        ckpt_path = model_dir / "speechtokenizer/pretrained_model/SpeechTokenizer.pt"
